...
def model_opts(parser):
    ...
    group.add('--feat_vec_size', '-feat_vec_size', type=int, default=512,
    ...
    group.add('--back_translation', '-back_translation', action="store_true",
              help='Use back translation.')
    ...
    group.add('--interactive_attn', '-interactive_attn', action="store_true",
              help='Use interactive attention on source and reference.')
...
def preprocess_opts(parser):
    ...
    group.add('--train_ref_src', '-train_ref_src', required=True,
              help="Path to the training reference source data")
    group.add('--train_ref_tgt', '-train_ref_tgt', required=True,
    ...
    group.add('--valid_ref_src', '-valid_ref_src', required=True,
              help="Path to the validation reference source data")
    group.add('--valid_ref_tgt', '-valid_ref_tgt', required=True,
...
def train_opts(parser):
    ...
    group.add('--start_checkpoint_at', '-start_checkpoint_at',
    ...
    group.add('--max_generator_batches', '-max_generator_batches',
              ...
              help="""Maximum batches of words in a sequence to run
                        ...
                        uses more memory.""")
    group.add('--pretrain_steps', '-pretrain_steps', type=int, default=10000,
              help='Number of pretraining steps')
    group.add('--train_steps', '-train_steps', type=int, default=30000,
    ...
    group.add('--adagrad_accumulator_init', '-adagrad_accumulator_init',
              ...
              help="""Initializes the accumulator values in adagrad.
                       ...
                       """)
    group.add('--max_grad_norm', '-max_grad_norm', type=float, default=15,
    ...
    group.add('--use_mask', '-use_mask', action='store_true',
              help="Use the masked reference")
    ...
    group.add('--start_decay_steps', '-start_decay_steps',
              ...
              help="""Start decaying every decay_steps after
                       start_decay_steps""")
    group.add('--decay_steps', '-decay_steps', type=int, default=1000,
...
def translate_opts(parser):
    ...
    group.add('--src', '-src', required=False, default='data/src-test.txt',
    ...
    group.add('--ref', '-ref', default='data/tgt-ref-test.txt',
                       help='reference target sequence (optional)')
    group.add('--output', '-output', default='data/pred.txt',
    ...
    group.add('--max_length', '-max_length', type=int, default=50,
    ...
    group.add('--alpha', '-alpha', type=float, default=0.2,
              help="""Google NMT length penalty parameter
                        (higher = longer generation)""")
    group.add('--beta', '-beta', type=float, default=0.2,
    ...
    group.add('--replace_unk', '-replace_unk', type=bool, default=True,
    ...
    group = parser.add_argument_group('Logging')
    group.add('--verbose', '-verbose', type=bool, default=True,
