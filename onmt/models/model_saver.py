...
class ModelSaverBase(object):
    ...
    def __init__(self, base_path, model, model_opt, fields, optim,
                 start_checkpoint_at, save_checkpoint_steps, keep_checkpoint=-1):
    ...
    def maybe_save(self, step):
        ...
        if step < self.start_checkpoint_at:
            return
...
class ModelSaver(ModelSaverBase):
    ...
    def __init__(self, base_path, model, model_opt, fields, optim, start_checkpoint_at,
                 save_checkpoint_steps, keep_checkpoint=0):
        super(ModelSaver, self).__init__(
            base_path, model, model_opt, fields, optim, start_checkpoint_at,
