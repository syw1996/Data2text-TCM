...
from onmt.modules import Embeddings, CopyGenerator, CoAttention
...
def build_base_model(model_opt, fields, gpu, checkpoint=None):
    ...
    if model_opt.interactive_attn:
        co_attention = CoAttention(model_opt.rnn_type, model_opt.brnn, model_opt.enc_layers,
    ...
    if model_opt.interactive_attn and model_opt.back_translation:
        model = onmt.models.NMTModel(encoder, tgt_encoder, decoder, co_attention=co_attention, generator=generator)
    elif model_opt.interactive_attn:
        model = onmt.models.NMTModel(encoder, tgt_encoder, decoder, co_attention=co_attention)
    elif model_opt.back_translation:
        model = onmt.models.NMTModel(encoder, tgt_encoder, decoder, generator=generator)
    else:
